...
def create_file_structure(REPO_OWNER, REPO_NAME, branch_name, structure, GITHUB_TOKEN):
        ...
        # Create a new branch
        new_branch_name = create_branch(repository_id, base_commit_oid, "fouad_mahmoud",GITHUB_TOKEN)
        ...
        commit_oid = create_commit(GITHUB_TOKEN,REPO_OWNER, REPO_NAME, new_branch_name, file_additions, "Create file structure", base_commit_oid)
